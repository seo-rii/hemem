...
libhemem-lru.so: hemem-lru.o lru.o timer.o interpose.o paging.o fifo.o spsc-ring.o
	$(CC) $(LDFLAGS) -o libhemem-lru.so hemem-lru.o timer.o lru.o interpose.o paging.o fifo.o spsc-ring.o $(HEMEM_LIBS)

libhemem-simple.so: hemem-simple.o simple.o timer.o interpose.o paging.o fifo.o spsc-ring.o
	$(CC) $(LDFLAGS) -o libhemem-simple.so hemem-simple.o timer.o simple.o interpose.o paging.o fifo.o spsc-ring.o $(HEMEM_LIBS)

libhemem-lru-swap.so: hemem-lru-swap.o lru_swap.o timer.o interpose.o paging.o fifo.o spsc-ring.o
	$(CC) $(LDFLAGS) -o libhemem-lru-swap.so hemem-lru-swap.o timer.o lru_swap.o interpose.o paging.o fifo.o spsc-ring.o $(HEMEM_LIBS)

hemem.o: hemem.c hemem.h pebs.h interpose.h fifo.h spsc-ring.h
	$(CC) $(CFLAGS) $(INCLUDES) -D ALLOC_HEMEM -c hemem.c -o hemem.o

hemem-lru.o: hemem.c hemem.h lru.h interpose.h paging.h fifo.h spsc-ring.h
	$(CC) $(CFLAGS) $(INCLUDES) -D ALLOC_LRU -c hemem.c -o hemem-lru.o

hemem-simple.o: hemem.c hemem.h simple.h interpose.h paging.h fifo.h spsc-ring.h
	$(CC) $(CFLAGS) $(INCLUDES) -D ALLOC_SIMPLE -c hemem.c -o hemem-simple.o

hemem-lru-swap.o: hemem.c hemem.h lru.h interpose.h paging.h fifo.h spsc-ring.h
...
lru.o: lru.c lru.h hemem.h fifo.h spsc-ring.h
	$(CC) $(CFLAGS) $(INCLUDES) -c lru.c

simple.o: simple.c simple.h hemem.h spsc-ring.h
	$(CC) $(CFLAGS) $(INCLUDES) -c simple.c

lru_swap.o: lru.c lru.h hemem.h fifo.h spsc-ring.h
